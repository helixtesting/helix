...
class ProductDescriptionsControllerTest < ActionController::TestCase
  ...
  test "should create product_description" do
    assert_difference('ProductDescription.count') do
      post :create, product_description: { body: @product_description.body, country_id: @product_description.country_id, product_type_id: @product_description.product_type_id, title: @product_description.title }
    end
  ...
  test "should update product_description" do
    put :update, id: @product_description, product_description: { body: @product_description.body, country_id: @product_description.country_id, product_type_id: @product_description.product_type_id, title: @product_description.title }
    assert_redirected_to product_description_path(assigns(:product_description))
  end
