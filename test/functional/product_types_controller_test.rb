...
class ProductTypesControllerTest < ActionController::TestCase
  ...
  test "should create product_type" do
    assert_difference('ProductType.count') do
      post :create, product_type: { country_id: @product_type.country_id, description: @product_type.description, name: @product_type.name }
    end
  ...
  test "should update product_type" do
    put :update, id: @product_type, product_type: { country_id: @product_type.country_id, description: @product_type.description, name: @product_type.name }
    assert_redirected_to product_type_path(assigns(:product_type))
  end
